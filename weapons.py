...
class Weapon:
    ...
    def attack(self, enemies):
        ...
        # Oblicz kierunek do najbliższego przeciwnika (tylko dla określenia początkowej trajektorii)
        ...
        for i in range(num_projectiles):
            ...
            angle_offset = 10 * (i - (num_projectiles - 1) / 2)  # rozrzut +/- 10 stopni * liczba pocisków
